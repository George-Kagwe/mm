  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">social media <span class="fa fa-chevron-down"></span></a>
          <ul class="dropdown-menu">
            <li><a href="<?=site_url('social/facebook')?>">facebook</a></li>
            <li><a href="<?=site_url('social/instagram')?>">instagram</a></li>
            <li><a href="<?=site_url('social/twitter')?>">twitter</a></li>
           
            <li><a href="<?=site_url('social/website')?>">Website</a></li>
          </ul>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
